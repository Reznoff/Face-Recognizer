...
import pp.facerecognizer.ui.AttendenceSummaryActivity;
import pp.facerecognizer.ui.HomeActivity;
...
//        trackingOverlay.postInvalidate();
        ...
        runInBackground(() -> {
            ...
            if (!mappedRecognitions.isEmpty()) {
                if (mappedRecognitions.get(0).getConfidence() >= 0.5f && mappedRecognitions.get(0).getTitle().equals("1")) {
                    Log.i("test", "Recognized as " + mappedRecognitions.get(0).getTitle());
                    if (!sharedPreference.getBoolean("clocked", false)) {
                        Intent i = new Intent(MainActivity.this, AttendenceSummaryActivity.class);
                        i.putExtra("name", mappedRecognitions.get(0).getTitle());
                        MainActivity.this.startActivity(i);
                    } else {
                        AndroidNetworking.post("https://private-df91b8-attendance15.apiary-mock.com/attendance/clock-out")
                                .setTag("Attendance")
                                ...
                                .getAsJSONObject(new JSONObjectRequestListener() {
                                    ...
                                    public void onResponse(JSONObject response) {
                                        sharedPreference.edit().putBoolean("clocked", false).apply();
                                        Toast.makeText(MainActivity.this, "Anda sudah clock-out", Toast.LENGTH_SHORT).show();
...
//                    trackingOverlay.postInvalidate();
            ...
            MainActivity.this.requestRender();
